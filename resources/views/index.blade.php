        ...
        <div id="layout-wrapper">
            ...
            <header id="page-topbar">
                <div class="navbar-header" style="background-color:rgb(255, 255, 255)">
                    <div class="d-flex">
                        <!-- LOGO -->
                        <div class="navbar-brand-box text-center" style="background-color:rgb(255, 255, 255)">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                onclick="event.preventDefault();
                                                         document.getElementById('logout-form').submit();"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Cerrar sesión</a>
